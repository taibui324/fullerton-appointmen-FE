...
export default function NewBooking() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5003/userbookings/search/"+email).then((res) => {
      if (res.data == 0) {
        console.log("no data");
      } else {
  ...
  const onSubmit = () => {
    ...
    axios
      .post("http://localhost:5003/userbookings/add", booking_data)
      .then((res) => {
        alert("booking done");
  ...
  return (
    <>
            ...
            <div className="register " class="registerback">
              <div
                ...
                <form onSubmit={handleSubmit(onSubmit)} class=" newrow">
                  <h3 class="section-header">Book Your Appointment</h3>
                  <br />
                  <div class=" indv">
                    <div
                      class="input-group"
                  ...
                  <span>
                    Booking Appointment <Link to="/mybooking">My Bookings Page</Link>
                  </span>
                  <br />
                </form>
              </div>
      ...
      : (
        <>
          <div><img class="fillpic" src="/lol.jpeg" style={{ width: "100%", height: "auto" }}/>
            <div className="register " class="registerback">
              <div
                className="register_container shadow"
                class="colorbox"
